...
namespace engone {
	...
	public:
        ...
        // callback(void* userData, string& path, ChangeType)
        typedef void (*Callback)(void*, const std::string&, ChangeType);
		...
		bool check(const std::string& root, Callback callback, void* userData, u32 flags = 0);
